...
public class mod_Kaevator_Corners extends BaseMod
{
    ...
    public mod_Kaevator_Corners()
    {
        ...
        ModLoader.addLocalization("KaevLightBlueWoolSlopesQuadriCornerDown.name", "Light Blue Sloped angle");
        ModLoader.addLocalization("KaevLightBlueWoolSlopesQuadriCornerUp.name", "Light Blue Ceiling angle");
        ModLoader.addLocalization("KaevLightBlueWoolSlopesTriCornerDown.name", "Light Blue Slanted Corner");
        ModLoader.addLocalization("KaevLightBlueWoolSlopesTriCornerUp.name", "Light Blue Slanted Corner");
